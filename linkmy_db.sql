...
--
-- Host: db:3306
-- Generation Time: Nov 18, 2025 at 10:36 PM
...
INSERT INTO `appearance` (`appearance_id`, `user_id`, `profile_title`, `bio`, `profile_pic_filename`, `bg_image_filename`, `theme_name`, `button_style`, `font_family`, `updated_at`, `custom_bg_color`, `custom_button_color`, `custom_text_color`, `custom_link_text_color`, `gradient_preset`, `profile_layout`, `container_style`, `enable_categories`, `show_profile_border`, `enable_animations`, `enable_glass_effect`, `shadow_intensity`) VALUES
(1, 1, 'Admin LinkMy', 'Welcome to LinkMy - Your Personal Link Hub', 'default-avatar.png', NULL, 'light', 'rounded', 'Inter', '2025-11-10 23:29:30', NULL, NULL, NULL, NULL, NULL, 'centered', 'wide', 0, 1, 1, 0, 'medium'),
(7, 7, 'mandatori', 'Welcome to my LinkMy page!', 'default-avatar.png', NULL, 'light', 'rounded', 'Inter', '2025-11-13 01:05:43', NULL, NULL, NULL, NULL, NULL, 'centered', 'wide', 0, 1, 1, 0, 'medium'),
(8, 8, 'Nyla', 'Welcome to my LinkMy page!', 'default-avatar.png', NULL, 'light', 'rounded', 'Inter', '2025-11-16 14:58:17', NULL, NULL, NULL, NULL, NULL, 'centered', 'wide', 0, 1, 1, 0, 'medium'),
(9, 9, 'MalingPangsit', 'Welcome to my LinkMy page!', 'default-avatar.png', NULL, 'dark', 'rounded', 'Inter', '2025-11-16 15:16:57', '#ffffff', '#667eea', '#333333', '#333333', 'Midnight Blue', 'centered', 'wide', 0, 1, 1, 0, 'medium'),
(10, 10, 'sumber_air_su_dekat', 'Welcome to my LinkMy page!', 'default-avatar.png', NULL, 'light', 'rounded', 'Inter', '2025-11-16 15:16:41', NULL, NULL, NULL, NULL, NULL, 'centered', 'wide', 0, 1, 1, 0, 'medium'),
(11, 11, 'AjiSantoso', 'Welcome to my LinkMy page!', 'default-avatar.png', NULL, 'light', 'rounded', 'Inter', '2025-11-16 17:08:12', NULL, NULL, NULL, NULL, NULL, 'centered', 'wide', 0, 1, 1, 0, 'medium'),
(12, 12, 'Fahmi', 'I Love Internet and tech', 'user_12_1763450873.jpg', NULL, 'gradient', 'pill', 'Inter', '2025-11-18 07:35:58', '#ffffff', '#9eb0ff', '#333333', '#000000', 'Pink Lemonade', 'minimal', 'wide', 0, 0, 1, 1, 'heavy'),
(13, 13, 'naganiga', 'Welcome to my LinkMy page!', 'default-avatar.png', NULL, 'light', 'rounded', 'Inter', '2025-11-18 03:59:27', NULL, NULL, NULL, NULL, NULL, 'centered', 'wide', 0, 1, 1, 0, 'medium');
...
(16, 12, 'INSTAGRAM', 'https://www.instagram.com/fahmi.ilham06/', 1, 'bi-instagram', 0, 1, '2025-11-18 05:38:56', NULL),
(17, 12, 'Toko Ngawi', 'https://shopee.co.id/', 2, 'bi-shop', 1, 1, '2025-11-18 06:27:04', NULL);
...
INSERT INTO `link_categories` (`category_id`, `user_id`, `category_name`, `category_icon`, `category_color`, `order_index`, `is_active`, `created_at`) VALUES
