...
--
-- Host: db:3306
-- Generation Time: Dec 02, 2025 at 01:10 AM
...
--
-- Table structure for table `old_email_verifications`
--

CREATE TABLE `old_email_verifications` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `old_email_verifications`
--

INSERT INTO `old_email_verifications` (`id`, `email`, `otp_code`, `created_at`, `expires_at`, `is_used`, `ip_address`, `verification_type`) VALUES
...
INSERT INTO `old_links` (`link_id`, `user_id`, `profile_id`, `title`, `url`, `order_index`, `icon_class`, `click_count`, `is_active`, `created_at`, `category_id`) VALUES
...
--
-- Table structure for table `old_link_analytics`
--

CREATE TABLE `old_link_analytics` (
...
--
-- Dumping data for table `old_link_analytics`
--

INSERT INTO `old_link_analytics` (`analytics_id`, `link_id`, `clicked_at`, `referrer`, `user_agent`, `ip_address`, `country`, `city`) VALUES
...
--
-- Dumping data for table `old_password_resets`
--

INSERT INTO `old_password_resets` (`id`, `email`, `reset_token`, `created_at`, `expires_at`, `is_used`, `ip_address`) VALUES
...
--
-- Table structure for table `old_profiles`
--
...
--
-- Dumping data for table `old_profiles`
--

INSERT INTO `old_profiles` (`profile_id`, `user_id`, `slug`, `profile_name`, `profile_description`, `profile_title`, `bio`, `profile_pic_filename`, `is_primary`, `is_active`, `created_at`, `updated_at`, `last_accessed_at`) VALUES
...
(7, 12, 'fahmi', 'fahmi - Main Profile', NULL, 'Fahmi Ilham Bagaskara', 'I Love Internet and tech', 'user_12_1763450873.jpg', 1, 1, '2025-11-29 14:34:56', '2025-11-30 02:57:05', NULL),
...
(16, 12, 'triforce', 'TRIFORCE', 'Menyimpan link penting di kelas', NULL, NULL, NULL, 0, 1, '2025-11-29 16:05:12', '2025-11-30 02:57:05', NULL);

--
-- Triggers `old_profiles`
--
DELIMITER $$
CREATE TRIGGER `sync_primary_slug_on_insert` AFTER INSERT ON `old_profiles` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `sync_primary_slug_on_update` AFTER UPDATE ON `old_profiles` FOR EACH ROW BEGIN
...
--
-- Table structure for table `old_profile_analytics`
--

CREATE TABLE `old_profile_analytics` (
  `analytics_id` int NOT NULL,
  `profile_id` int NOT NULL,
  `date` date NOT NULL,
...
--
-- Table structure for table `old_sessions`
--
...
--
-- Dumping data for table `old_sessions`
--

INSERT INTO `old_sessions` (`session_id`, `session_data`, `session_expire`) VALUES
('11df0ee7945fc8959d74b2aa9483be40', '', 1765037683),
('252e1330ef75380fd6a3924e343cb21f', '', 1765078741),
('3140bee33bf1f05f6e245a9d6cb94e93', 'user_id|i:12;username|s:5:\"fahmi\";page_slug|s:5:\"fahmi\";last_activity|i:1764473709;active_profile_id|i:7;', 1765078509),
...
('72c3e6c9daf14ef854677443e9becf98', 'user_id|i:12;username|s:5:\"fahmi\";page_slug|s:5:\"fahmi\";last_activity|i:1764577248;active_profile_id|i:7;', 1765182048),
('8bc23cac8dbadd7f65f80e4c7e0a7c27', 'user_id|i:12;username|s:5:\"fahmi\";page_slug|s:5:\"fahmi\";last_activity|i:1764471889;active_profile_id|i:7;', 1765076689),
('95c285dc01b011d473e897199548cdbd', 'user_id|i:12;username|s:5:\"fahmi\";page_slug|s:5:\"fahmi\";last_activity|i:1764474071;active_profile_id|i:7;', 1765078871),
...
('d565b58b5f24dd750248f4d9df99c35d', 'user_id|i:12;username|s:5:\"fahmi\";page_slug|s:5:\"fahmi\";last_activity|i:1764597113;active_profile_id|i:7;', 1765201913),
...
INSERT INTO `old_users` (`user_id`, `username`, `password_hash`, `page_slug`, `active_profile_id`, `email`, `email_verified`, `email_verified_at`, `created_at`, `is_verified`, `last_slug_change_at`) VALUES
...
(12, 'fahmi', '$2y$10$N7EAhQe57LT7a.yzLH7WbeYsB/8/.ySFY/RY8Co54RdyW558HEQbe', 'fahmi', 7, 'fahmiilham029@gmail.com', 1, '2025-11-18 03:56:37', '2025-11-18 03:56:37', 1, NULL),
...
--
-- Table structure for table `old_user_appearance`
--

CREATE TABLE `old_user_appearance` (
...
--
-- Indexes for table `old_email_verifications`
--
ALTER TABLE `old_email_verifications`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `old_link_analytics`
--
ALTER TABLE `old_link_analytics`
...
--
-- Indexes for table `old_profiles`
--
ALTER TABLE `old_profiles`
...
--
-- Indexes for table `old_profile_analytics`
--
ALTER TABLE `old_profile_analytics`
  ADD PRIMARY KEY (`analytics_id`),
  ADD UNIQUE KEY `unique_profile_date` (`profile_id`,`date`),
  ADD KEY `idx_date` (`date`);

--
-- Indexes for table `old_sessions`
--
...
--
-- Indexes for table `old_user_appearance`
--
ALTER TABLE `old_user_appearance`
...
--
-- AUTO_INCREMENT for table `old_email_verifications`
--
ALTER TABLE `old_email_verifications`
...
--
-- AUTO_INCREMENT for table `old_link_analytics`
--
ALTER TABLE `old_link_analytics`
  MODIFY `analytics_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `old_password_resets`
--
ALTER TABLE `old_password_resets`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `old_profiles`
--
ALTER TABLE `old_profiles`
  MODIFY `profile_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `old_profile_analytics`
--
ALTER TABLE `old_profile_analytics`
...
--
-- AUTO_INCREMENT for table `old_user_appearance`
--
ALTER TABLE `old_user_appearance`
...
--
ALTER TABLE `categories`
  ADD CONSTRAINT `categories_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `old_users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `link_categories`
--
ALTER TABLE `link_categories`
  ADD CONSTRAINT `fk_category_user` FOREIGN KEY (`user_id`) REFERENCES `old_users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_link_categories_profile` FOREIGN KEY (`profile_id`) REFERENCES `old_profiles` (`profile_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `old_links`
--
ALTER TABLE `old_links`
  ADD CONSTRAINT `fk_link_category` FOREIGN KEY (`category_id`) REFERENCES `link_categories` (`category_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_links_profile` FOREIGN KEY (`profile_id`) REFERENCES `old_profiles` (`profile_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `old_links_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `old_users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `old_link_analytics`
--
ALTER TABLE `old_link_analytics`
  ADD CONSTRAINT `fk_analytics_link` FOREIGN KEY (`link_id`) REFERENCES `old_links` (`link_id`) ON DELETE CASCADE;

--
-- Constraints for table `old_profiles`
--
ALTER TABLE `old_profiles`
  ADD CONSTRAINT `fk_profiles_user` FOREIGN KEY (`user_id`) REFERENCES `old_users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `old_profile_analytics`
--
ALTER TABLE `old_profile_analytics`
  ADD CONSTRAINT `fk_profile_analytics` FOREIGN KEY (`profile_id`) REFERENCES `old_profiles` (`profile_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `old_user_appearance`
--
ALTER TABLE `old_user_appearance`
  ADD CONSTRAINT `fk_user_appearance_profile` FOREIGN KEY (`profile_id`) REFERENCES `old_profiles` (`profile_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `profile_activity_log`
--
ALTER TABLE `profile_activity_log`
  ADD CONSTRAINT `fk_activity_profile` FOREIGN KEY (`profile_id`) REFERENCES `old_profiles` (`profile_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
